...
namespace RhinoGeometry {
    public static class BakeUtil {
        ...
        public static Polyline Rectangle(this Plane plane, double w=100, double h=100) {
            return new Rhino.Geometry.Rectangle3d(plane, new Interval(-w, w), new Interval(-h, h)).ToPolyline();
        }
